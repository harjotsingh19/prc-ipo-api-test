const { enableMFA, verifyMFA, updateProfile, addUserActivity, getUserProfile, logout, changePassword } = require('./swaggerComp/user');
...
const swaggerDefinition = {
    ...
    definition: {
        ...
        paths: {
            ...
            "/admin/investors-investments/{walletAddress}": adminComp.getInvestorInvestments,
            ...
            "/admin/distribution-analytics/{saleId}": adminComp.getDistributionAnalytics,
            ...
            "/investor/investment/vesting-schedule/{id}": investorComp.viewVestingSchedule,
