...
router.post("/register", validator.validateUserSignup(),validator.result, authController.registerInvestor);
router.post("/verifyOtp",validator.validateOtp(),validator.result, authController.verifyOTP);
